            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="listBooks">
                                <i class="icon-pencil"></i> 图书列表
                            </a>
                        </li>
                        <li>
                            <a href="addBook" target="_blank">
                                <i class="icon-pencil"></i> 图书信息登记
                            </a>
                        </li>
                        <li>
                            <a href="addCa" target="_blank">
                                <i class="icon-pencil"></i> 图书种类添加与删除
                            </a>
                        </li>
                                        ...
                                        <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                            ...
                                            <c:forEach items="${pageUserInfo.list }" var="user">
                                                <tr>
                                                    ...
                                                    <c:if test="${user.isvip==1}"><th>黄铜会员</th></c:if>
                                                    <c:if test="${user.isvip==2}"><th>白银会员</th></c:if>
                                                    <c:if test="${user.isvip==3}"><th>黄金会员</th></c:if>
                                                    <c:if test="${user.isvip==4}"><th>白金会员</th></c:if>
                                                    <c:if test="${user.isvip==5}"><th>钻石会员</th></c:if>
                                                    <th>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <nav aria-label="Page navigation">
                                                    <ul class="pagination">
                                                        <li><a href="listVips?pn=1">首页</a></li>
                                                        <c:if test="${pageUserInfo.hasPreviousPage }">
                                                            <li><a href="listVips?pn=${pageUserInfo.pageNum-1}"
                                                        ...
                                                        <c:forEach items="${pageUserInfo.navigatepageNums }" var="page_Num">
                                                            ...
                                                            <c:if test="${page_Num != pageUserInfo.pageNum }">
                                                                <li><a href="listVips?pn=${page_Num }">${page_Num }</a></li>
                                                            </c:if>
                                                        ...
                                                        <li><a href="listVips?pn=${pageUserInfo.pages}">末页</a></li>
                                                    </ul>
                                                </nav>
                                            </div>
                                        </div>
