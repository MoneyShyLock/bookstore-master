                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="left">
                            <span class="btn btn-app btn-sm btn-light no-hover">
                                <span class="line-height-1 bigger-170 blue"> ${countAll.child} </span><br/>
                                <span class="line-height-1 smaller-90"> 少儿 </span>
                            </span>

                            <span class="btn btn-app btn-sm btn-yellow no-hover">
                                <span class="line-height-1 bigger-170"> ${countAll.literature}  </span><br/>
                                <span class="line-height-1 smaller-90"> 文学 </span>
                            </span>
                            <span class="btn btn-app btn-sm btn-pink no-hover">
                                <span class="line-height-1 bigger-170"> ${countAll.novel}  </span><br/>
                                <span class="line-height-1 smaller-90"> 小说 </span>
                            </span>
                            <span class="btn btn-app btn-sm btn-grey no-hover">
                                <span class="line-height-1 bigger-170"> ${countAll.economicManagement}  </span><br/>
                                <span class="line-height-1 smaller-90"> 经济管理 </span>
                            </span>
                            <span class="btn btn-app btn-sm btn-success no-hover">
                                <span class="line-height-1 bigger-170"> ${countAll.life}  </span><br/>
                                <span class="line-height-1 smaller-90"> 生活 </span>
                            </span>
                            <span class="btn btn-app btn-sm btn-primary no-hover">
                                <span class="line-height-1 bigger-170"> ${countAll.exam}  </span><br/>
...
<script>
    function changeDate(type){
        $.ajax({
            type: "GET",
            data:["type",type],
            url: "echartsOutBookByType?type="+type,
            dataType: "json",
